...
struct GeoCoord
{
    ...
    /*
    bool operator>(const GeoCoord& g) const {
...
struct StreetSegment
{
    ...
    /*
    bool operator==(const StreetSegment& s) const{
        return ((segment.start == s.segment.start && segment.end == s.segment.end) || (segment.start == s.segment.end && segment.end == s.segment.start));
    }
     */
