...
int main(){
    ...
    Navigator nav;
    nav.loadMapData("/Users/Saquib/Documents/Bunni/Q2/CS32/Project4/Project4b/Project4b/mapdata.txt");
    //nav.navigate("Franz Hall", "Royce Hall", dir);
    //nav.navigate("Diddy Riese", "Fox Theater", dir);
    //nav.navigate("Bollywood Bites", "Fox Theater",dir);
    nav.navigate("1061 Broxton Avenue", "Headlines!", dir);
    //nav.navigate("Holly", "Public Affairs", dir);
    //nav.navigate("Harvard-Westlake Middle School", "Greystone Mansion", dir);
    //nav.navigate("barrington recreation center", "BH small animal hospital", dir);
    //nav.navigate("Getty Conservation Institute", "bollywood bites", dir);
...
int main()
{
    ...
    {
        MapLoader ml;
        assert(ml.load("/Users/Saquib/Desktop/testBruinNav/testmap.txt"));
    ...
    {
        Navigator nav;
        assert(nav.loadMapData("/Users/Saquib/Desktop/testBruinNav/testmap.txt"));
